...
import com.zenchn.nfcdemo.util.SuperToast;

/**
 * @author:Hzj
 * @date :2018/11/2/002
 * desc  ：通常来说，所有处理NFC的Activity都要设置launchMode属性为singleTop或者singleTask，保证了无论NFC标签靠近手机多少次，Activity实例只有一个
...
public class BaseNfcActivity extends AppCompatActivity {
    ...
    public void onResume() {
        super.onResume();
        if (mNfcAdapter == null) {
            SuperToast.showDefaultMessage(this, "您的手机不支持NFC功能！");
